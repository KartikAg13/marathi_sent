...
* **Project Goal**
* To develop a deep learning model capable of accurately classifying Marathi text into Positive, Negative, and Neutral sentiments.
...
* **Dataset:** MahaSent
* **Source:** Raw data from `dataset/raw/` containing `Train.csv`, `Val.csv`, and `Test.csv`.
